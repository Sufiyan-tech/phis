                                                ...
                                                <div class="card card-full">
                                                    ...
                                                    <div class="nk-tb-list mt-n2">
                                                        <div class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <div class="nk-tb-col tb-col-md"><span>Username</span></div>
                                                        ...
                                                        <div class="nk-tb-item">
                                                            ...
                                                            <div class="nk-tb-col tb-col-sm">
                                                                <div class="user-card">
                                                                    <div class="user-name">
                                                                        <span class="tb-lead">Aslam Khan</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="nk-tb-col tb-col-md">
                                                                <span class="tb-sub">aslam.khan</span>
                                                            </div>
                                                            <div class="nk-tb-col tb-col-md">
                                                                <span class="tb-sub">aslam.khan@email.com</span>
                                                            </div>
                                                            <div class="nk-tb-col tb-col-md">
                                                                <span class="tb-sub">Manager</span>
                                                            </div>
                                                            <div class="nk-tb-col tb-col-md">
                                                                <span class="tb-sub">National</span>
                                                            </div>
                                                            <div class="nk-tb-col">
