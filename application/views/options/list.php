                        ...
                        <div class="toggle-wrap nk-block-tools-toggle">
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                    <li class="nk-block-tools-opt"><a href="<?php echo base_url();?>options/create" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Add new</span></a></li>
                                </ul>
                            </div>
                        </div><!-- .toggle-wrap -->
                    </div>
                            ...
                            <div class="card card-full">
                                ...
                                <div class="nk-tb-list mt-n2">
                                    <div class="nk-tb-item nk-tb-head">
                                        ...
                                        <div class="nk-tb-col tb-col-sm"><span>Options Name</span></div>
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-sm">
                                            <div class="user-card">
                                                <div class="user-name">
                                                    <span class="tb-lead"><?php echo $option['name'];?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="nk-tb-col">
                                            <?php echo get_labeled_status($option['status']);?>
                                        </div>
                                        <div class="nk-tb-col">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-auto">
                                                    <ul class="link-list-plain">
                                                        <li><a href="<?php echo base_url();?>options/edit/<?php echo $option['idoption'];?>">Edit</a></li>
