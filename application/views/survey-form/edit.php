                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Edit Survey form</h3>
                    ...
                    <div class="col-lg-12">
                        <div class="card h-100">
                            <div class="card-inner">
                                ...
                                <form action="<?php echo base_url();?>survey/update/<?php echo $surveyform['idsurveyform'];?>" method="POST" class="form-validate is-alter">

                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label class="form-label" for="full-name">Name</label>
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="label" name="label" required value="<?php echo $surveyform['name'];?>">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="slug" name="slug" required value="<?php echo $surveyform['slug'];?>">
                                            ...
                                            <div class="form-control-wrap">
                                                <select class="form-select" data-placeholder="Select Sub Component" name="subcomponent" required onchange="change_indicators(this);">
                                                        ...
                                                        foreach ($subcomponents as $k => $v): ?>
                                                            <option value="<?php echo $v['idsubcomponent'] ?>" <?php if($surveyform['idsubcomponent'] == $v['idsubcomponent']){echo "selected";}?>><?php echo $v['subcomponent_name'] ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-control-wrap">
                                                <select class="form-control" id="status" name="status" placeholder="Select status" required>
                                                    ...
                                                    <option value="2" <?php if($surveyform['status'] == 2){echo "selected";}?>>Active</option>
                                                    <option value="1" <?php if($surveyform['status'] == 1){echo "selected";}?>>Inactive</option>
                                                </select>
                                                                    ...
                                                                    <div class="nk-tb-item">
                                                                        <div class="nk-tb-col nk-tb-col-check">
                                                                            <div class="custom-control custom-control-sm custom-checkbox notext">
                                                                                <input type="checkbox" class="custom-control-input checkSingle" name="ind_id[]" value="<?php echo $indicator['idindicator']; ?>" id="uid<?php echo $key;?>" <?php if(in_array($indicator['idindicator'], $allformInd)){echo "checked";}?>>
