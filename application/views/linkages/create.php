                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Add new linkage</h3>
                        ...
                        <div class="col-lg-12">
                            <div class="card h-100">
                                <div class="card-inner">
                                    ...
                                    <form action="<?php echo base_url();?>linkages/add" method="POST" class="form-validate is-alter">
                                                    ...
                                                    <select class="form-control" id="component" name="component" required>
                                                        ...
                                                        <?php if($components){
                                                            foreach ($components as $key => $component) {?>
                                                                <option data-value="<?php echo $component['type'];?>" value="<?php echo $component['idcomponent'];?>"><?php echo $component['component_name'];?></option>
                                                            <?php }
                                                        }?>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="link" name="link" placeholder="https://google.com">
