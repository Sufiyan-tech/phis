                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Add New Year</h3>
                    ...
                    <div class="col-lg-12">
                        <div class="card h-100">
                            <div class="card-inner">
                                <form action="<?php echo base_url();?>years/add" method="POST" class="form-validate is-alter">
                                    <div class="row">
                                        <div class="col-md-6">
                                                ...
                                                <div class="form-control-wrap">
                                                    <select class="form-select" data-placeholder="Select Survey Form" name="idsurveyform" required>
                                                        ...
                                                        <?php foreach ($forms as $k => $v): ?>
                                                            <option value="<?php echo $v['idsurveyform'] ?>"><?php echo $v['name'] ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox mt-3 mb-3 change-value">
                                                    <input type="checkbox" class="custom-control-input" id="national" name='national' value="0">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox mt-3 mb-3 change-value">
                                                    <input type="checkbox" class="custom-control-input" id="province" name='province' value="0">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox mt-3 mb-3 change-value">
                                                    <input type="checkbox" class="custom-control-input" id="district" name='district' value="0">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" class="custom-control-input checkSingle" name="province_code[]" value="<?php echo $v['province_code']; ?>" id="uid<?php echo $k;?>">
